...
export const ErrorPage: React.FC = () => {
  // TODO Contact Button Functionality / email or report issue

  return (
    <main className="grid min-h-full absolute top-0 left-0 w-full bg-white px-6 py-24 sm:py-52 lg:px-8">
